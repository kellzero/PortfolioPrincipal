    ...
    <section className="container mx-auto px-4 md:px-6 py-16 flex flex-col-reverse md:flex-row items-center">
      ...
      >
        ...
        <p className="mt-4 text-lg md:text-xl text-muted-foreground max-w-lg">
          Desenvolvedor Full-Stack Python em formação, com experiência em
          front-end e projetos práticos que foram e-commerces e aplicações web.
          Possuo inglês avançado e sou movido pela resolução criativa de
          problemas, unindo minha paixão por hardware e software.
        </p>
