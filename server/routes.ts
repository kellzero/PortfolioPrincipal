    ...
    const projects = [
      {
        ...
        description:
          "A fully-featured RESTful API for e-commerce platforms with authentication, product management, and order processing.",
        imageSrc:
      ...
      },
      {
        ...
        description:
          "Interactive dashboard with real-time data visualization for monitoring system performance and user analytics.",
        imageSrc:
      ...
      },
      {
        ...
        description:
          "AI-powered application that generates unique content for blogs, social media, and marketing materials.",
        imageSrc:
      ...
      },
      {
        ...
        description:
          "Elegant task management application with drag-and-drop interface, task prioritization, and deadline tracking.",
        imageSrc:
          "https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
        demoUrl: "https://vercel.com/",
        githubUrl: "https://github.com/",
      ...
      },
      {
        ...
        description:
          "Advanced data analysis tool for processing large datasets, generating insightful visualizations, and creating reports.",
        imageSrc:
      ...
      },
      {
        ...
        description:
          "Feature-rich social media platform with real-time messaging, content sharing, and user engagement analytics.",
        imageSrc:
      ...
      const repos = [
        {
          ...
          description:
            "A collection of advanced Python utilities for data processing, file operations, and more.",
        ...
        },
        {
          ...
          description:
            "Reusable and accessible React components with TypeScript support and comprehensive documentation.",
          url: "https://github.com/username/repo-name",
          stars: 76,
          forks: 23,
          language: "TypeScript",
        ...
        },
        {
          ...
          description:
            "Production-ready Django REST API boilerplate with authentication, permissions, and documentation.",
          url: "https://github.com/username/repo-name",
          stars: 112,
          forks: 37,
          language: "Python",
        ...
        },
        {
          ...
          description:
            "Practical recipes for common machine learning tasks using Python, TensorFlow, and scikit-learn.",
          url: "https://github.com/username/repo-name",
          stars: 89,
          forks: 18,
          language: "Python",
